...
exports.down = (pgm) => {
  pgm.sql(`
    ...
    DROP TABLE legal_document_versions;
    DROP TABLE legal_documents;
    DROP TABLE external_identity_reconciliations;
    DROP TABLE account_contact_changes;
    DROP TABLE application_sessions;
    DROP TABLE editorial_assignments;
    DROP TABLE role_history;
    DROP TABLE account_state_history;
    DROP TABLE system_bootstrap_records;
    DROP TABLE user_accounts;
    DROP FUNCTION sergod_validate_active_legal_document();
    DROP FUNCTION sergod_protect_legal_version();
    DROP FUNCTION sergod_protect_legal_document();
    DROP FUNCTION sergod_prevent_change();
  `);
};
