...
const downSql = `
  DROP INDEX collections_public_search_idx;
  DROP INDEX categories_public_search_idx;
  DROP INDEX tcg_games_public_search_idx;
  DROP INDEX products_public_search_idx;
  DROP INDEX products_public_condition_filter_idx;
  DROP INDEX products_public_edition_filter_idx;
  DROP INDEX products_public_language_filter_idx;
  DROP INDEX products_public_price_desc_order_idx;
  DROP INDEX products_public_price_asc_order_idx;
  DROP INDEX products_public_name_order_idx;
  DROP INDEX products_public_newest_order_idx;
  DROP INDEX collections_public_game_name_order_idx;
  DROP INDEX collections_public_name_order_idx;
  DROP INDEX categories_public_name_order_idx;
  DROP INDEX tcg_games_public_name_order_idx;
  DROP FUNCTION public.sergod_catalog_search_normalize(text);
`;
