...
const downSql = `
  DROP FUNCTION sergod_protect_loyalty_movement() CASCADE;
  DROP FUNCTION sergod_protect_loyalty_configuration() CASCADE;
  DROP FUNCTION sergod_create_loyalty_account_for_user() CASCADE;
  DROP TABLE loyalty_movements;
  DROP TABLE loyalty_configurations;
