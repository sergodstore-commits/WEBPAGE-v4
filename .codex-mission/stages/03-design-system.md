# Stage 03-design-system — Design system base

## Objetivo

Implementar tokens/componentes base responsive conforme a CURRENT: negro/rojo/blanco, cian solo acento, angular/halftone. No rehacer todavía todas las pantallas ni tocar lógica de negocio.
