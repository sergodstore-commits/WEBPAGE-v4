# Stage 15-notifications — Email transaccional

## Objetivo

Implementar NotificationPort + email adapter para eventos mínimos CURRENT. Elegir proveedor sin acoplar Domain. Credencial puede quedar DEFERRED_EXTERNAL.
