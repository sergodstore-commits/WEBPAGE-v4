# Stage 16-e2e-integration — E2E e integración transversal

## Objetivo

Cubrir recorridos principales: registro/login, compra regular Flow/Webpay (sandbox si disponible), pago rechazado/reintento, stock concurrente, POS, preventa, pickup, freight collect, cuenta/admin.
