# Stage 06-payments-core — Payments core

## Objetivo

Implementar PaymentAttempt, puertos/adaptadores y orquestación independiente de proveedor. No almacenar tarjeta; browser return no aprueba.
