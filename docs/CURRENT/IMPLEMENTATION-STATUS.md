...
| Admin                                                                                       | Datos operativos en preview    | 10 rutas, estados traducidos, selectores operativos y resultados sin JSON crudo         | Completar E2E transaccional de operaciones críticas  |
