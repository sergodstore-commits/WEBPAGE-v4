-- SERGOD-WEB-V1-R5 Phase 2: safe evolution to verified email-only authentication.
-- Historical phone verification and PHONE_PASSWORD session evidence is preserved.
